  ...
  Widget graph() {
    ...
    if (api.monthData.isEmpty) {
      ...
      widget.generateData(widget.tabControllerIndex).then((value) {
        ...
        if (api.apiErrorMonth == false &&
            api.fetchDataErrorMonth == false &&
            api.isInternetErrorMonth == false &&
